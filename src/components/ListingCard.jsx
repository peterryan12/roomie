...
export const ListingCard = (props) => {
    ...
    return <div className="grid rounded p-5 grid-cols-[1fr_2fr] mt-15 max-h-[10em] overflow-hidden bg-indigo-50 items-center border-[0.5px]" onClick={() => navigate('/details')}>
